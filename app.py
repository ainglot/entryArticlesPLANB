...
with st.form("entry_form"):
    ...
    MitigationName = st.text_input("Mitigation Name", max_chars=255)
    Type = st.text_input("Type", max_chars=255)
    Subtype = st.text_input("Subtype", max_chars=255)
    ScaleOfImplementation = st.text_input("Scale of Implementation", max_chars=255)
    ImpactOnLightPollution = st.text_input("Impact on Light Pollution", max_chars=255)
    ImpactOnNoisePollution = st.text_input("Impact on Noise Pollution", max_chars=255)
    CauseOfPollutionAddressed = st.text_input("Cause of Pollution Addressed", max_chars=255)
    AdditionalPollutionImpacts = st.text_input("Additional Pollution Impacts", max_chars=255)
